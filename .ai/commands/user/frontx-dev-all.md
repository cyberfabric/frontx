...
(See `frontx-add-mfe-to-registry.md`)
...
- `frontx-new-mfe.md` - Create new MFE package
- `frontx-add-mfe-to-registry.md` - Register MFE in system
- `.ai/GUIDELINES.frontx-mfe-setup.md` - MFE architecture guidelines
