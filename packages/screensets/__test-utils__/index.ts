...
export { createMinimalMfeRegistryStub } from './minimal-screensets-registry-stub';
export {
...
// @cpt-end:cpt-frontx-dod-mfe-registry-handler-injection:p1:inst-screensets-test-utils-barrel
