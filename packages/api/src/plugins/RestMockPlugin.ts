...
export class RestMockPlugin extends RestPluginWithConfig<RestMockConfig> {
   ...
   */
  // @cpt-begin:cpt-hai3-algo-api-communication-mock-factory-match:p2:inst-find-mock-factory
  ...
  // @cpt-end:cpt-hai3-algo-api-communication-mock-factory-match:p2:inst-find-mock-factory

  /**
   * Match URL against pattern with :params.
   */
  // @cpt-begin:cpt-hai3-algo-api-communication-mock-factory-match:p2:inst-match-url-pattern
  ...
  // @cpt-end:cpt-hai3-algo-api-communication-mock-factory-match:p2:inst-match-url-pattern

  /**
   * Simulate network delay.
   */
  // @cpt-begin:cpt-hai3-flow-api-communication-mock-activation:p2:inst-simulate-delay
  private simulateDelay(): Promise<void> {
    return new Promise((resolve) => setTimeout(resolve, this.config.delay ?? 0));
  }
  // @cpt-end:cpt-hai3-flow-api-communication-mock-activation:p2:inst-simulate-delay
