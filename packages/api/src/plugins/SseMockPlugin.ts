...
export class SseMockPlugin extends SsePluginWithConfig<SseMockConfig> {
   ...
   */
  // @cpt-begin:cpt-hai3-algo-api-communication-sse-mock-match:p2:inst-find-mock-events
  ...
  // @cpt-end:cpt-hai3-algo-api-communication-sse-mock-match:p2:inst-find-mock-events

  /**
   * Match URL against pattern.
   * Supports simple prefix matching and exact matching.
   */
  // @cpt-begin:cpt-hai3-algo-api-communication-sse-mock-match:p2:inst-match-url-pattern
  ...
  // @cpt-end:cpt-hai3-algo-api-communication-sse-mock-match:p2:inst-match-url-pattern
