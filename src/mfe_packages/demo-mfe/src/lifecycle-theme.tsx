...
/**
 * Lifecycle implementation for the Current Theme entry in the demo MFE.
 * Extends ThemeAwareReactLifecycle to inherit theme subscription logic.
 *
 * This class provides Current Theme-specific Tailwind utilities and renders
 * the CurrentThemeScreen component. The bridge is passed through as a prop for
...
class CurrentThemeLifecycle extends ThemeAwareReactLifecycle {
  ...
  /**
   * Render the Current Theme screen component.
   *
