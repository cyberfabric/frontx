...
export function hai3MfeExternalize(options: Hai3MfeExternalizeOptions): Plugin {
   ...
   *   assets/__federation_shared_@cyberfabric/react-BYlz3jvo.js → @cyberfabric/react
   */
  ...
  return {
    ...
    generateBundle(_options, bundle): void {
      ...
      // (like __federation_shared_@cyberfabric/react.js at 22 kB importing jsx-runtime.js).
      //
      ...
      //
      //   __federation_shared_@cyberfabric/react.js (22 kB) imports jsx-runtime.js (5 kB)
