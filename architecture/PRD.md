...
**Role**: Scaffolds new projects (`hai3 create`), generates layout and screenset code (`hai3 scaffold`), runs migrations (`hai3 migrate`), syncs AI tool configs (`hai3 ai sync`). Orchestrates screenset lifecycle operations: copy, promote, delete, list, activate.

#### Product Manager

**ID**: `cpt-hai3-actor-product-manager`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-screenset-definition`
...
**Actors**: `cpt-hai3-actor-cli`, `cpt-hai3-actor-product-manager`

#### Shell Ownership and Customizability

- [ ] `p1` - **ID**: `cpt-hai3-fr-shell-ownership`
...
**Actors**: `cpt-hai3-actor-product-manager`, `cpt-hai3-actor-ai-agent`, `cpt-hai3-actor-ux-designer`

#### Shared MFE Packages

- [ ] `p1` - **ID**: `cpt-hai3-fr-shared-packages`
...
**Actors**: `cpt-hai3-actor-product-manager`, `cpt-hai3-actor-developer`

#### Package Modification Isolation

- [ ] `p1` - **ID**: `cpt-hai3-fr-package-isolation`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-screenset-creation`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-stage-transitions`
...
**Actors**: `cpt-hai3-actor-cli`, `cpt-hai3-actor-ux-designer`, `cpt-hai3-actor-developer`

#### Screenset Deletion and Cleanup

- [ ] `p1` - **ID**: `cpt-hai3-fr-screenset-deletion`
...
- [ ] `p1` - **ID**: `cpt-hai3-fr-screenset-listing`
...
**Actors**: `cpt-hai3-actor-cli`, `cpt-hai3-actor-product-manager`, `cpt-hai3-actor-developer`

#### Active Screenset Selection

- [ ] `p1` - **ID**: `cpt-hai3-fr-screenset-activation`
...
**Actors**: `cpt-hai3-actor-cli`, `cpt-hai3-actor-dev-server`

#### Studio Screenset Selector

- [ ] `p1` - **ID**: `cpt-hai3-fr-studio-screenset-selector`
...
**Actors**: `cpt-hai3-actor-studio-user`, `cpt-hai3-actor-product-manager`, `cpt-hai3-actor-ux-designer`

#### AI Agent Integration

- [ ] `p1` - **ID**: `cpt-hai3-fr-ai-agent-integration`
...
**Actors**: `cpt-hai3-actor-ai-agent`, `cpt-hai3-actor-product-manager`

#### Production Build Isolation

- [ ] `p1` - **ID**: `cpt-hai3-fr-screenset-build-isolation`
...
**Actors**: `cpt-hai3-actor-build-system`, `cpt-hai3-actor-developer`

#### Multi-Product Support

- [ ] `p1` - **ID**: `cpt-hai3-fr-multi-product`
...
**Actors**: `cpt-hai3-actor-developer`, `cpt-hai3-actor-product-manager`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-screenset-ops-perf`
...
- [ ] `p2` - **ID**: `cpt-hai3-nfr-screenset-scalability`
...
- [ ] `p1` - **ID**: `cpt-hai3-nfr-screenset-build-isolation`
...
- [ ] `p1` - **ID**: `cpt-hai3-usecase-pm-prototyping`

**Actor**: `cpt-hai3-actor-product-manager`
...
**Alternative Flows**:
- **AI modifies a shared MFE package**: The system ensures the modification is isolated to this screenset without affecting other screensets (per `cpt-hai3-fr-package-isolation`)
- **PM wants more variants**: PM creates additional copies, each independently modifiable

#### Designer Creates Styling Variants

- [ ] `p2` - **ID**: `cpt-hai3-usecase-designer-styling`

**Actor**: `cpt-hai3-actor-ux-designer`
...
- [ ] `p1` - **ID**: `cpt-hai3-usecase-dev-production`
...
- [ ] `p2` - **ID**: `cpt-hai3-usecase-cross-product-sharing`
...
**Alternative Flows**:
- **One product needs a customized version**: Developer creates an isolated copy of the package for that product's screenset (per `cpt-hai3-fr-package-isolation`)
